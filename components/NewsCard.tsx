...
const NewsCard = ({ image, category, title, excerpt, date, link }: NewsCardProps) => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden w-full max-w-sm hover:shadow-lg transition-shadow">
      <div className="h-48 relative">
        {image ? (
        <Image src={image} alt={title} fill className="object-cover" sizes="(max-width: 640px) 100v" />
