...
const Accordion = () => {
  ...
  const faqs: AccordionItemType[] = [
    ...
    },
    {
      ...
      answer: "We follow all government health guidelines and recommendations. Our venues have adequate capacity for social distancing, and we encourage attendees to follow personal safety measures as needed."
    },
  ];
